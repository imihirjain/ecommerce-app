...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center py-5 font-medium">
      <Link to={"/"}>
        <img src={assets.logo} className="w-24 lg:w-36 " alt="" />
      </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute right-[-5px] bottom-[-5px] text-white w-4 text-center bg-black leading-4 rounded-full aspect-square text-[10px]">
            10
          </p>
        </Link>
        <img
